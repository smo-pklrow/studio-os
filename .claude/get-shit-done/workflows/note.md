...
- **Global scope**: `C:/Projects/studio-os/.claude/skills/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Projects/studio-os/.claude/skills/.claude/notes/`)
...
2. Glob `C:/Projects/studio-os/.claude/skills/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Projects/studio-os/.claude/skills/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Projects/studio-os/.claude/skills/.claude/notes/` — works in any directory
