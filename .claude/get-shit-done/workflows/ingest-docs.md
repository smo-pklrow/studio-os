...
```bash
INIT=$(node "C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
