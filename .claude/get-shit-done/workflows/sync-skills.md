...
INSTALL_JS_GLOBAL="C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
