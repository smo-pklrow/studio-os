...
<required_reading>
@C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/references/user-story-template.md
@C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/references/spidr-splitting.md
@C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/references/spidr-splitting.md`. Briefly:
