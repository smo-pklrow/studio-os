...
```markdown
Read C:/Projects/studio-os/.claude/skills/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Projects/studio-os/.claude/skills/.claude/agents/gsd-ui-checker.md for instructions.
