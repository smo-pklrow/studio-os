...
```
Agent(
  prompt="Read C:/Projects/studio-os/.claude/skills/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/templates/VALIDATION.md`
