...
```bash
INIT=$(node "C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/templates/spec.md.
