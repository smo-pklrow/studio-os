...
- Usage: Reference from command with `@C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to C:/Projects/studio-os/.claude/skills/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/Projects/studio-os/.claude/skills/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
