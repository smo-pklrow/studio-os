...
<required_reading>
Read `C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
