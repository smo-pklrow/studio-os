...
<required_reading>
@C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Projects/studio-os/.claude/skills/.claude
                  → checks C:/Projects/studio-os/.claude/skills/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Projects/studio-os/.claude/skills/.claude/get-shit-done
                  → writes to C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/hooks/
...
@C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/references/common-bug-patterns.md
