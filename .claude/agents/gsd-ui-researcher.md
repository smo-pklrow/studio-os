...
Use template from `C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/templates/UI-SPEC.md`
