...
Reference full template: `C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/templates/state.md`.
