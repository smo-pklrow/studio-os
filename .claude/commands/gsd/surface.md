...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Projects/studio-os/.claude/skills/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=C:/Projects/studio-os/.claude/skills/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=C:/Projects/studio-os/.claude/skills/.claude/commands/gsd
AGENTS_DIR=C:/Projects/studio-os/.claude/skills/.claude/agents
```
...
<execution_context>
Surface state file: `C:/Projects/studio-os/.claude/skills/.claude/skills/.gsd-surface.json`
Install profile marker: `C:/Projects/studio-os/.claude/skills/.claude/skills/.gsd-profile`
Engine module: `C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
