...
**CJS-only (graphify):** `graphify` subcommands are not registered on `gsd-sdk query`. Use `node C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/bin/gsd-tools.cjs graphify …` as documented in this command and in `docs/CLI-TOOLS.md`. Other tooling may still use `gsd-sdk query` where a handler exists.
...
Knowledge graph is disabled. To activate:
  ...
  node C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```bash
node "C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build
```
...
graphify update . \
  ...
  && node "C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build snapshot \
  && node "C:/Projects/studio-os/.claude/skills/.claude/get-shit-done/bin/gsd-tools.cjs" graphify status
```
